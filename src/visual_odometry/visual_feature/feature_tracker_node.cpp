...
void lidar_callback(const sensor_msgs::PointCloud2ConstPtr& laser_msg)
{
    ...
    *laser_cloud_in = *laser_cloud_in_ds;
    ...
    for (int i = 0; i < (int)laser_cloud_in->size(); ++i)
    {
        ...
        // p.y / p.x的阈值怎么确定655 根据相机的视野来判断阈值
    ...
    *laser_cloud_in = *laser_cloud_in_filter;
    ...
    Eigen::Affine3f transOffset = pcl::getTransformation(L_C_TX, L_C_TY, L_C_TZ, L_C_RX, L_C_RY, L_C_RZ);//雷达到相机的外参 根据分析应该是Tcl
    ...
    *laser_cloud_in = *laser_cloud_offset;
    ...
    pcl::transformPointCloud(*laser_cloud_in, *laser_cloud_global, transNow); //Twc
