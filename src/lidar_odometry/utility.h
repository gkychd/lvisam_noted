...
public:
    ...
    */
    sensor_msgs::Imu imuConverter(const sensor_msgs::Imu& imu_in)
    {
        ...
        Eigen::Quaterniond q_from(imu_in.orientation.w, imu_in.orientation.x, imu_in.orientation.y, imu_in.orientation.z);//Rwi
        Eigen::Quaterniond q_final = q_from * extQRPY;//将roll pitch yaw转到lidar系下 extQRPY = Ril_rpy -> Rwl
